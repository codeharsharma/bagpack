package com.example.bagpack.Data;
...
import com.example.bagpack.Constants.MyConstants;
import com.example.bagpack.Database.RoomDB;
...
public class AppData extends Application {
    ...
    public List<Items>getClothingData(){
        String []data={"Stockings","Underwear","Pajamas",
                ...
                "Cost", "Rain Coat", "love", "Wat", "Scarf", "Bikini", "Belt", "Slipper", "Sneakers", "Casual Shoes",
    ...
    public List<Items> getBabyNeedsData() {
            ...
            String []data ={"Snapsuit", "Outfit", "Jumpsuit", "Baby Sacks", "Baby Hat", "Baby Pyjamas", "Baby Bath Towel", "Muslin ", "Blanket", "Dribble Bibs", "Baby Laundry Detergent",
                    ...
                    "Highchairs", "Diaper", "Wet Wipes", "Baby Cotton","Baby Cel Cover", "Baby Shampoo", "Baby soap", "Baby Nail Scissors",

                    "Body Moisturizer", "Potty", "diaper Rash Cream", "Serum Physiological", "Nasal Aspirator", "Fly Repellent Lotion", "Pyrometer", "Antipyretic Syrup", "Probiotic Power",

                    "Baby Backpack", "Stroller", "Baby Carrier", "Toys", "Teether", "Playpen", "Playpen", "Baby Radio", "Non-slip See Shoes", "Baby Sunglasses"};

            return prepareItemsList(MyConstants.BABY_NEEDS_CAMEL_CASE, data);
        }
            public List<Items> getHealthData() {

                String []data={"Aspirin", "Drugs Used", "Vitamins Used", "Lens Solutions", "Condo", "Hot Water Bag","Tincture of Lodine", "Adhesive Plaster",
    ...
    public List<Items> getTechnologyData() {
        ...
        String[] data = {"Mobile Phone", "Phone Cover", "E-Book Reader", "Camera", "Camera Charger",
                "Portable Speaker", "IPad (Tab)", "Headphone","Laptop", "Laptop Charger", "Mouse", "Extension cable", "Data Transfer Cable",
