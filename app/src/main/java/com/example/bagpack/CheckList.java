...
import com.example.bagpack.Adapter.CheckListAdapter;
import com.example.bagpack.Constants.MyConstants;
import com.example.bagpack.Data.AppData;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()==R.id.btnMySelection){
            ...
            new AlertDialog.Builder(this).setTitle("Delete default data")
                    .setMessage("Are you sure?\n\nAs this will delete the data provided by(Bag Pack) while installing")
            ...
            new AlertDialog.Builder(this).setTitle("Reset to default")
                    .setMessage("Are you sure?\n\nAs this will load the default data provided by(Bag Pack)"+
